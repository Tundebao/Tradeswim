...
import { AlertCircle, Check, Pencil, Plus, Search, Star, Trash2, Database } from "lucide-react"
...
const AdminSymbols = () => {
  ...
  const handleToggleActive = (id: number) => {
    setSymbols((prev) => prev.map((s) => (s.id === id ? { ...s, isActive: !s.isActive } : s)))
  }
      ...
      <div className="space-y-8">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground">Add and manage trading symbols and watchlists</p>
          </div>
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-[550px]">
              <form onSubmit={handleSubmit}>
                <DialogHeader>
                  <DialogTitle>{isEditMode ? "Edit Symbol" : "Add New Symbol"}</DialogTitle>
                  <DialogDescription>
                    {isEditMode ? "Update the details for this symbol" : "Add a new symbol to the watchlist"}
                  </DialogDescription>
                </DialogHeader>
                ...
                <DialogFooter>
                  ...
                  <Button type="submit">{isEditMode ? "Update Symbol" : "Add Symbol"}</Button>
                </DialogFooter>
              </form>
            </DialogContent>
          </Dialog>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Manage symbols used in trading and copy trading</CardDescription>
          </CardHeader>
          <CardContent>
            {isLoading ? (
                ...
                <TableBody>
                  {filteredSymbols.map((symbol) => (
                    <TableRow key={symbol.id}>
                      ...
                      <TableCell>
                        <Badge variant={symbol.isActive ? "default" : "secondary"} className="capitalize">
                      ...
                      <TableCell className="text-right">
                        <div className="flex justify-end space-x-2">
                          ...
                          <Button variant="ghost" size="icon" onClick={() => handleOpenDialog(symbol)}>
                            <Pencil className="h-4 w-4 text-blue-500" />
                          </Button>
                          <Button variant="ghost" size="icon" onClick={() => handleDelete(symbol.id)}>
