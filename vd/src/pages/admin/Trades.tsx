      ...
      <div className="space-y-8">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground">View and analyze all trades executed on your accounts</p>
          </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-yellow-700">
                  <p>Connect a broker account to view your trade history. Go to the Accounts page to add a broker.</p>
                </div>
                <div className="mt-4">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Narrow down your trade history by applying filters</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Complete history of all trading activity</CardDescription>
          </CardHeader>
          <CardContent>
            {isLoading ? (
                  ...
                  {filteredTrades.map((trade) => (
                    <TableRow key={trade.id}>
                      ...
                      <TableCell className="font-medium">
                        {trade.symbol}
                        {trade.is_option && <span className="ml-1 text-xs text-muted-foreground">(Option)</span>}
                      </TableCell>
                      <TableCell>
                        <Badge
                          variant="outline"
                      ...
                      <TableCell className="capitalize">
                        ...
                        {trade.order_type === "limit" && trade.limit_price && (
                          <span className="ml-1">@ ${trade.limit_price.toFixed(2)}</span>
                        )}
                      </TableCell>
                      <TableCell>
              ...
              <div className="text-center py-12">
                ...
                <p className="mt-1 text-sm text-gray-500">No trades match your current filter criteria.</p>
              ...
              <div className="text-center py-12">
                ...
                <p className="mt-1 text-sm text-gray-500">Connect a broker to view trade history.</p>
              </div>
            )}
          </CardContent>
        </Card>
