...
import { type BrokerCredentials, BrokerType, type BrokerAccount, BrokerConnectionStatus } from "@/types/broker"
import {
      ...
      case BrokerConnectionStatus.ERROR:
        return (
          <span
            ...
            title={broker.connection_error || "Error connecting to broker"}
          >
      ...
      <div className="space-y-8">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground">Manage your broker connections and credentials</p>
          </div>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  {submitSuccess && (
                    <Alert className="my-4 bg-green-50 border-green-200 text-green-800">
                      ...
                      <AlertDescription>Broker account connected successfully!</AlertDescription>
                    </Alert>
                  )}
                  ...
                  <div className="grid gap-4 py-4">
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                      ...
                      <div className="col-span-3">
                        <Select value={formData.broker_type} onValueChange={handleSelectChange} disabled={isSubmitting}>
                          <SelectTrigger id="broker_type">
                            <SelectValue placeholder="Select broker" />
                          </SelectTrigger>
                          <SelectContent>
                            <SelectItem value={BrokerType.TASTYTRADE}>Tastytrade</SelectItem>
                            <SelectItem value={BrokerType.SCHWAB}>Charles Schwab</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                    </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Your broker connections and their status</CardDescription>
          </CardHeader>
          <CardContent>
            {isLoading ? (
                ...
                <TableBody>
                  {brokerCredentials.map((broker) => (
                    <TableRow key={broker.id}>
                      ...
                      <TableCell>
                        {broker.broker_type === BrokerType.TASTYTRADE ? broker.username : broker.client_id}
                      </TableCell>
                      <TableCell>{renderConnectionStatus(broker)}</TableCell>
                      <TableCell>
                        {broker.created_at ? new Date(broker.created_at).toLocaleDateString() : "Unknown"}
                      </TableCell>
                      <TableCell className="text-right">
                        <div className="flex justify-end items-center gap-2">
                          ...
                          >
                            <RefreshCw
                              className={`h-4 w-4 ${isHealthCheckRecent(broker) ? "text-green-500" : "text-gray-500"}`}
                            />
                          </Button>
                          <Button
                            variant="ghost"
        ...
        {brokerAccounts.length > 0 && (
          <Card className="mt-8">
            <CardHeader>
              ...
              <CardDescription>Trading accounts associated with your broker connections</CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
                      ...
                      <TableCell>
                        <span
                          className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${
                            account.is_active ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800"
                          }`}
                        >
      ...
      >
        <DialogContent className="sm:max-w-[425px]">
          ...
          <div className="flex justify-end space-x-2 pt-4">
            ...
            <Button variant="destructive" onClick={confirmDeleteBroker} disabled={isDeleting !== null} type="button">
              {isDeleting !== null ? (
                <>
