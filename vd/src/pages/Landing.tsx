    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      <div className="container mx-auto px-4 py-24 flex flex-col items-center justify-center text-center">
        ...
        <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mb-12">
          Secure, real-time trading platform for stocks and options with live broker integrations. Designed for
          professional traders who demand reliability and performance.
        </p>
        ...
        <p className="mt-24 text-sm text-gray-500 max-w-xl">
          This platform is for professional use only and requires valid broker credentials. No paper trading or
