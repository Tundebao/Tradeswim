...
import { CopyTradingSettings } from "@/types/broker";
import { 
  getCopyTradingSettings, 
  updateCopyTradingSettings, 
  toggleCopyTrading 
} from "@/services/copyTradingService";
      ...
      <div className="space-y-8">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Configure how trades are allocated across follower accounts
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            {settings.allocation_type === "fixed" && (
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Fixed dollar amount to use for each copied trade.
                </p>
              </div>
            )}
                  ...
                  <div className="p-4 border rounded-md bg-gray-50">
                    <div className="flex items-start space-x-2">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          These settings require a connected broker account to take effect.
                          Make sure to test these settings carefully before enabling them for production use.
                        </p>
                      </div>
                    </div>
                  </div>
