  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      const demoSymbols: Symbol[] = [
        { id: 1, symbol: "AAPL", name: "Apple Inc.", type: "stock", price: 188.52, change: 2.34, changePercent: 1.25, isFavorite: true },
        { id: 2, symbol: "MSFT", name: "Microsoft Corp.", type: "stock", price: 332.81, change: -1.56, changePercent: -0.47, isFavorite: true },
        { id: 3, symbol: "AMZN", name: "Amazon.com Inc.", type: "stock", price: 178.22, change: 3.45, changePercent: 1.97, isFavorite: false },
        { id: 4, symbol: "GOOGL", name: "Alphabet Inc.", type: "stock", price: 137.14, change: 0.75, changePercent: 0.55, isFavorite: false },
        { id: 5, symbol: "META", name: "Meta Platforms Inc.", type: "stock", price: 477.40, change: 5.23, changePercent: 1.11, isFavorite: true },
      ];
      ...
      <div className="space-y-8">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground">
              Track your favorite symbols and see real-time prices
            </p>
          </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Track symbols that you're interested in trading
            </CardDescription>
          </CardHeader>
          <CardContent>
            {isLoading ? (
