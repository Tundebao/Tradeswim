        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground">
              Overview of your trading accounts and performance
            </p>
          </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-yellow-700">
                  <p>
                    You need to connect a real broker account before you can see
                    balance information and start trading. Go to the Admin Panel
                    to connect a broker.
                  </p>
                </div>
                <div className="mt-4">
                      ...
                      >
                        ...
                        <div className="text-right">
                          ...
                          <div className="text-sm text-gray-500">
                            BP: {formatCurrency(account.buying_power)}
                          </div>
                        </div>
                      </div>
                    ))}
          ...
          <Card className="md:col-span-2">
            ...
            <CardContent className="h-[300px] flex items-center justify-center">
              {isLoading ? (
                ...
                <div className="text-center text-gray-500">
                  Connect a broker to view performance data
                </div>
              )}
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              {isLoading ? (
                ...
                <div className="text-center text-gray-500 py-12">
                  Connect a broker to view trades
                </div>
              )}
            </CardContent>
          </Card>
